...
function Body() {
  return (
    ...
    <img id='top-img' src={require("../Image/bathing_banner.webp")} />
    ...
    <div className="cards-rows">
      <CardGroup>
        <Card id="cards">
          <div className="hover-img">
            <img id="img1" src={require("../Image/All images/body_barsoap1pack.webp")} />
            <img id="img2" src={require("../Image/All images/body_barsope2.webp")} />
          </div>
          <h6 id="sale">Sale</h6>
          <a>Bar Soap 2 Pack</a>
          <p>
        ...
        <Card id="cards">
          <div className="hover-img">
            <img id="img1" src={require("../Image/All images/Deoronate1.webp")} />
            <img id="img2" src={require("../Image/All images/body_DeodorantScentDuo2.webp")} />
          </div>
          <a>Deodorant</a>
          <p>$14.00</p>
          <button>Choose options</button>
        ...
        <Card id="cards">
          <div className="hover-img">
            <img id="img1" src={require("../Image/All images/body_bodywhash1.webp")} />
            <img id="img2" src={require("../Image/All images/body_bodywash2.webp")} />
          </div>
          <a>Body Wash</a>
          <p>$14.00</p>
          <button>Choose options</button>
        ...
        <Card id="cards">
          <div className="hover-img">
            <img id="img1" src={require("../Image/All images/body_barsope1.webp")} />
            <img id="img2" src={require("../Image/All images/body_body_barsope2.webp")} />
          </div>
          <a>Bar Soap</a>
          <p>$8.00</p>
          <button>Choose options</button>
      ...
      <CardGroup id='secondcard-row'>
        <Card id="cards">
          <div className="hover-img">
            <img id="img1" src={require("../Image/All images/JumboBodyWash1.webp")} />
            <img id="img2" src={require("../Image/All images/JumboBodyWash2.webp")} />
          </div>
          <a>Jumbo Body Wash</a>
          <p>$36.00</p>
          <button>Choose options</button>
        ...
        <Card id="cards">
          <div className="hover-img">
            <img id="img1" src={require("../Image/All images/body_DeodorantScentDuo1.webp")} />
            <img id="img2" src={require("../Image/All images/body_DeodorantScentDuo2.webp")} />
          </div>
          <h6 id="sale">Sale</h6>
        ...
        <Card id="cards">
          <div className="hover-img">
            <img id="img1" src={require("../Image/All images/body_ShowerLoofah1.webp")} />
            <img id="img2" src={require("../Image/All images/body_ShowerLoofah2.webp")} />
          </div>
          <a>Shower Loofah</a>
          <p>$6.00</p>
          <button>Add to cart</button>
        ...
        <Card id="cards">
          <div className="hover-img">
            <img id="img1" src={require("../Image/All images/body_BodyWashTravelSize1.jpg")} />
            <img id="img2" src={require("../Image/All images/kits_HairandBodyKit2.webp")} />
          </div>
          <h6 id="sale">Sale</h6>
      ...
      <div id="list-content-img">
        <img id="body-img" src={require("../Image/Huron_Shoot_bundil.webp")} />
