...
function Kits() {
  return (
   ...
   <img id='top-img' src={require("../Image/kit_banner.webp")} />
   ...
   <CardGroup>
       <Card id="kits-cards">
         <div className="hover-img">
           <img id="kit-img1" src={require("../Image/BodyDuo_Original_GreyBG.webp")} />
           <img id="kit-img2" src={require("../Image/body-wash-3_566b3fc3.webp")} />
         </div>
         <h6 id="sale">Sale</h6>
         <a>Body Duo</a>
         <p>
       ...
       <Card id="kits-cards">
         <div className="hover-img">
           <img id="kit-img1" src={require("../Image/HuronBigger3_GrayBG.webp")} />
           <img id="kit-img2" src={require("../Image/huron-home-body_f9c45261.webp")} />
         </div>
       ...
       <Card id="kits-cards">
         <div className="hover-img">
           <img id="kit-img1" src={require("../Image/huron_pdp_shower-kit-1.webp")} />
           <img id="kit-img2" src={require("../Image/body_wash.webp")} />
         </div>
     ...
     <CardGroup id='secondcard-row'>
       <Card id="kits-cards">
         <div className="hover-img">
           <img id="kit-img1" src={require("../Image/HuronBigger3_GrayBG.webp")} />
           <img id="kit-img2" src={require("../Image/huron_facekit-2.webp")} />
         </div>
         <a>Face Kit</a>
         <p>$45.00</p>
       ...
       <Card id="kits-cards">
         <div className="hover-img">
           <img id="kit-img1" src={require("../Image/All images/kits_JumboHairandBodyKit1.webp")} />
           <img id="kit-img2" src={require("../Image/All images/kits_JumboHairandBodyKit2.webp")} />
         </div>
         <h6 id="sale">Sale</h6>
       ...
       <Card id="kits-cards">
         <div className="hover-img">
           <img id="kit-img1" src={require("../Image/All images/kits_kitsHairDuo1.webp")} />
           <img id="kit-img2" src={require("../Image/All images/kits_kitsHairDuo2.webp")} />
         </div>
         <h6 id="sale">Sale</h6>
         <a>Hair Duo</a>
         <p>
